...
import ceid.netcins.exo.catalog.*;
import ceid.netcins.exo.content.*;
import ceid.netcins.exo.messages.*;
...
public class CatalogService extends PastImpl implements SocService {
     ...
     * @param contentId The Id of the taging content (checksum, SHA-1 of synonyms
     *                  etc.).
     ...
     *
     * @param result The array of results, result[i] could be null or ScoreBoard
     *               instance.
