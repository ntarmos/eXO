...
public class DummyContent extends ContentHashPastContent {
	...
	public DummyContent(Id id, Id nodeId, int version) {
		...
		nodeList.add(nodeId); // During creation in the Starting Node there is
	...
	public PastContent checkInsert(Id id, PastContent existingContent)
		...
		/*
		 * TODO : edw 8a ginetai h enhmerwsh tou content tou NodeLIST dhladh 8a
		 * elegxetai to TreeSet kai 8a enhmerwnetai me ta nea NodeIds
		 */
		if (existingContent != null) {
			if (existingContent instanceof DummyContent) {
				...
				throw new PastException(
						"DummyContent: can't insert, object already exists");
		}
