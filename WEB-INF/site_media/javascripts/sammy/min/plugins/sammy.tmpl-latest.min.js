...
(function(i, f) {
    ...
    function k(B, A, D, E) {
        var C = {data:E || (A ? A.data : {}),_wrap:A ? A._wrap : null,tmpl:null,parent:A || null,nodes:[],calls:c,nest:b,wrap:n,html:r,update:z};
        if (B) {
    ...
    i.fn.extend({tmpl:function(C, B, A) {
    ...
    i.extend({tmpl:function(C, F, E, B) {
        var D,A = !B;
        if (A) {
            B = x;
    ...
    Sammy.Tmpl = function(C, A) {
        var B = function(E, F, D) {
            ...
            return i.tmpl(D, i.extend({}, this, F))
        };
        if (!A) {
            A = "tmpl"
        }
