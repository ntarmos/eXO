...
public class User {
    ...
    // User nick(screen) name in the network. This name will be indexed as a field!
    // in the userProfile!
     ...
     * @param friends
     */
    public User(Id uid, String username, ContentProfile userProfile, List<Friend> friends){
        this.uid = uid;
