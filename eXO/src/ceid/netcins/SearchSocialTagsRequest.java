...
public class SearchSocialTagsRequest extends Request{
     ...
     * @deprecated
     */
    @Deprecated public SearchSocialTagsRequest(String qterms, int[] nodeNumbers){
     ...
     * @deprecated
     */
    @Deprecated public SearchSocialTagsRequest(String qterms, int[] nodeNumbers,int source){
        super();
        this.qterms = qterms;
        this.source = source;
