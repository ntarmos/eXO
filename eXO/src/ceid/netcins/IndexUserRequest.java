 ...
 * The profile contains separate fields which must be provided
 * as a map with the corresponding keywords or phrases.
 * 
...
public class IndexUserRequest extends Request{
    ...
    public IndexUserRequest(Map<String,String> userProfile, int source, String delimiter){  
        super();
