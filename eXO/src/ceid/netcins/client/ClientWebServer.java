 ...
 * is responsible to handle end to end user traffic, as well as UI requests.
 * This enables the use of web interfaces, rich web based frontends which 
 * communicate by using GET or POST in normal or asynchronous http packets.
 * A usefull choice is AJAX.
 * 
 * @author andy
 */
public class ClientWebServer  implements HttpHandler{
    ...
    public void handle(HttpExchange t) throws IOException {
        try {
            ...
            Logger.getLogger(ClientWebServer.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();
        }
