...
/**This Class holds the Content Profile of a content object.
 * Such an object is stored in a Catalog Entry.
 * When an indexing process is in progress this object is "serialized"
 * and send to the corresponding Catalog nodes.
 *
 * @author andy
 */
public class ContentProfile implements Serializable{
    ...
    /**
     * This is a convenient method to present the profile terms 
     * without the corresponding term frequencies.
     * 
     * @return A full representation of the ContentProfile data
     */
