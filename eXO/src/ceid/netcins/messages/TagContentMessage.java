...
public static final short TYPE = 10;
   ...
   */
  public TagContentMessage(int uid, Id id, NodeHandle source, Id dest, TagContentPDU tcPDU) {
...
public void serialize(OutputBuffer buf) throws IOException {
  ...
  public static TagContentMessage build(InputBuffer buf, Endpoint endpoint, PastContentDeserializer pcd) throws IOException {
  ...
  private TagContentMessage(InputBuffer buf, Endpoint endpoint, PastContentDeserializer pcd) throws IOException {
    super(buf, endpoint);
    if (serType == S_SUB) {
