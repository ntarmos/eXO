...
public class RetrieveContMessage extends ContinuationMessage {
   ...
   */
  public RetrieveContMessage(int uid, Id id, NodeHandle source, Id dest, RetrieveContPDU rcpdu) {
  ...
  public static RetrieveContMessage build(InputBuffer buf, Endpoint endpoint, PastContentDeserializer pcd) throws IOException {
  ...
  private RetrieveContMessage(InputBuffer buf, Endpoint endpoint, PastContentDeserializer pcd) throws IOException {
    super(buf, endpoint);
    if (serType == S_SUB) {
