 ...
 * The permitted requests are listed in scenarios.dtd
 *
 * @author andy
 */
public class Scenario {
     ...
     */
    public Scenario(Vector<Request> index_submitted, Vector<Request> search_submitted,
    ...
    public boolean isFinished(){
        if((this.index_submitted == null || this.index_submitted.isEmpty())
                && (this.search_submitted == null || this.search_submitted.isEmpty())
                && (this.tag_submitted == null || this.tag_submitted.isEmpty())
                && (this.randomQueries_submitted == null || this.randomQueries_submitted.isEmpty())){
            return true;
        }
        return false;
    }
