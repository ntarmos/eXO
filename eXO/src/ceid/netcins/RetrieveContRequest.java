...
/**
 * A request by the user to retrieve some content object with any tagclouds
 * if requested.
 *
 * @author andy
 */
public class RetrieveContRequest extends Request{
     ...
     * @deprecated
     */
    @Deprecated public RetrieveContRequest(boolean cloud, String cid, int uid){
     ...
     * @deprecated
     */
    @Deprecated public RetrieveContRequest(boolean cloud, String cid, int uid,int source){
        super();
        this.cloud = cloud;
        this.source = source;
        this.uid = uid;
     ...
     * @param source
     */ 
    public RetrieveContRequest(boolean cloud, Id contentId, Id userId,int source){
        super();
        this.cloud = cloud;
        this.source = source;
        this.contentId = contentId;
