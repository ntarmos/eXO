...
public class URLCatalogEntry extends ContentCatalogEntry implements Serializable, Comparable{
     ...
     */
    public URLCatalogEntry(Id uid, ContentProfile tags, ContentProfile usrp,URL url){
        super(uid,tags,usrp);
        this.url = url;
    }
   ...
   * just they have the same UID
   * This is correct as we have a
   * catalog per URL (TID).
   *
...
public boolean equals(Object o) {
   ...
   /**
    * A representation of the entry
    * sewed to the specific class
    * 
    * @return
    */
   @Override
