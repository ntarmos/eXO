...
/**
 * Represents a request for searching specific content through a number
 * of content terms
 * 
 * @author andy
 */
public class SearchContentRequest extends Request{
    ...
    public SearchContentRequest(String query, int type, int source, int k, String delimiter){
        super();
        this.query = query;
        this.queryType = type;
        this.source = source;
