...
public class JavaSerializer {
   ...
   public static void serialize(OutputBuffer buf, Object content) throws IOException {
    try {
   ...
   public static Object deserialize(InputBuffer buf, Endpoint endpoint) throws IOException {    
